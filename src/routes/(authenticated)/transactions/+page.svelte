<script lang="ts">
	...
	const data: [string, string, string, string, string, CreditCard['state']][] = [
		['Payment from Bonnie Green', 'Apr 23 ,2021', '$2300', '0047568936', 'Visa', 'completed'],
		['Payment refund to #00910', 'Apr 23 ,2021', '-$670', '0078568936', 'Mastercard', 'completed'],
		['Payment failed from #087651', 'Apr 18 ,2021', '$234', '0088568934', 'Visa', 'cancelled'],
		['Payment from Lana Byrd', 'Apr 15 ,2021', '$5000', '0018568911', 'Mastercard', 'inprogress'],
		['Payment from Jese Leos', 'Apr 15 ,2021', '$2300', '0045568939', 'Mastercard', 'completed'],
		['Refund to THEMESBERG LLC', 'Apr 11 ,2021', '-$560', '0031568935', 'Visa', 'inreview'],
		['Payment from Lana Lysle', 'Apr 6 ,2021', '$1437', '0023568934', 'Mastercard', 'inreview'],
		['Payment to Joseph Mcfall', 'Apr 1 ,2021', '$980', '0057568935', 'Visa', 'completed'],
		['Payment from Alphabet', 'Mar 23 ,2021', '$11,436', '00836143841', 'Visa', 'inprogress'],
		['Payment from Bonnie Green', 'Mar 23 ,2021', '$560', '0031568935', 'Mastercard', 'completed']
	];
</script>
		...
		<TableBody>
			{#each data as [name, date, amount, reference, method, status]}
				<TableBodyRow>
					...
					>
						<CreditCard cardType={method} />
						<span>••• {reference.slice(reference.length - 4, reference.length)}</span>
					</TableBodyCell>
					<TableBodyCell class="px-4 font-normal"><StatusBadge state={status} /></TableBodyCell>
				</TableBodyRow>
			{/each}
		</TableBody>
	</Table>
