<script>
    ...
    import { SearchOutline, ChevronDownOutline, ChartPieSolid, MailBoxOutline, DollarOutline, CreditCardOutline, HomeOutline, FileLinesOutline} from 'flowbite-svelte-icons';
    import { Input, Button, Sidebar, SidebarGroup, SidebarItem, SidebarWrapper, Navbar, NavBrand, NavLi, NavUl, NavHamburger, Avatar, Dropdown, DropdownItem, DropdownHeader, DropdownDivider } from 'flowbite-svelte';
    ...
    <nav class="bg-white border-b border-gray-200 px-4 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
      <div class="flex flex-wrap justify-between items-center">
        <div class="flex justify-start items-center">
            ...
            <!-- Sidebar toggle control in mobile view -->
          ...
          <NavBrand href="/" class="flex items-center justify-between mr-4">
            ...
            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Better Teller</span>
          </NavBrand>
        ...
        <div class="flex items-center lg:order-2">
            ...
            <!-- Toggle Search button for mobile view -->
          ...
          <!-- User dropdown menu -->
          <div id="dropdown" class="hidden z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600 rounded-xl">
            <div class="py-3 px-4">
              <span class="block text-sm font-semibold text-gray-900 dark:text-white" >Sanjeev Mishra</span>
              <span class="block text-sm text-gray-900 truncate dark:text-white">sanjeev.mishra@dskbank.bg</span>
            </div>
